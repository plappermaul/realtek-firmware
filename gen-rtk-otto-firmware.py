...
def show_result(filename):
    ...
    print("")
    print("  ethernet-switch@1b000000 {")
    print("    compatible = \"realtek,rtl9301-switch\", \"syscon\", \"simple-mfd\";")
    print("    reg = <0x1b000000 0x10000>;")
    print("    interrupt-parent = <&intc>;")
    print("    interrupts = <23>, <24>;")
    print("    interrupt-names = \"switch\", \"nic\";")
    print("    #address-cells = <1>;")
    print("    #size-cells = <1>;")
    print("")
    print("    serdes: phy@3b0 {")
